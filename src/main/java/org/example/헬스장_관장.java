...
public class 헬스장_관장 {
    ...
    public void 승급_심사_남은_운동횟수_체크(캐릭터 게임_캐릭터) {
        if (게임_캐릭터.등급 == 1) {
            int 초급_승급_심사_남은_운동횟수 = 초급_승급_심사_해야할_운동횟수-진행중인_승급심사_운동_실행_횟수;
            System.out.println("남은 운동 횟수 -> " + 초급_승급_심사_남은_운동횟수 + "회");
        } else if (게임_캐릭터.등급 == 2) {
            int 중급_승급_심사_남은_운동횟수 = 중급_승급_심사_해야할_운동횟수-진행중인_승급심사_운동_실행_횟수;
            System.out.println("남은 운동 횟수 -> " + 중급_승급_심사_남은_운동횟수+ "회");
        } else if (게임_캐릭터.등급 == 3) {
            int 고급_승급_심사_남은_운동횟수 = 고급_승급_심사_해야할_운동횟수-진행중인_승급심사_운동_실행_횟수;
            System.out.println("남은 운동 횟수 -> " + 고급_승급_심사_남은_운동횟수+ "회");
        } else if (게임_캐릭터.등급 == 4) {
            int 초월_승급_심사_남은_운동횟수 = 고급_승급_심사_해야할_운동횟수-진행중인_승급심사_운동_실행_횟수;
